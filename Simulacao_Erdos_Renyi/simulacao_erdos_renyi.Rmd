...
print(paste0("Número de arestas presentes na simulação com N = 100 e Lambda = 2.5: ", (simulacao1$grau_vertices %>% sum())/2))
```
...
print(paste0("Número de arestas presentes na simulação com N = 100 e Lambda = 2.5: ", (simulacao2$grau_vertices %>% sum())/2))
```
...
print(paste0("Número de arestas presentes na simulação com N = 100 e Lambda = 2.5: ", (simulacao3$grau_vertices %>% sum())/2))
```
...
print(paste0("Número de arestas presentes na simulação com N = 100 e Lambda = 2.5: ", (simulacao4$grau_vertices %>% sum())/2))
```
